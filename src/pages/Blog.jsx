  ...
  return (
    <>
      <div className="guten-lizrFz entry-content is-layout-constrained guten-post-content guten-element">
              ...
              <div className="wp-block-gutenverse-column guten-element guten-column guten-U3mRNL">
                <div className="guten-column-wrapper" data-id="U3mRNL">
                  <div className="guten-lybajg guten-post-block guten-element">
                    <div className="gutenverse guten-postblock postblock-type-5 guten-pagination-loadmore post-element guten-lybajg">
        ...
        {/* Newsletter Section */}
        <div className="section-wrapper" data-id="p80Vpy">
          <section className="wp-block-gutenverse-section guten-element guten-section guten-p80Vpy layout-boxed align-stretch">
            <div className="guten-container guten-column-gap-default">
              <div className="wp-block-gutenverse-column guten-element guten-column guten-oeOtFB">
                <div className="guten-column-wrapper" data-id="oeOtFB">
                  <div className="guten-background-overlay"></div>
                  <div className="guten-element guten-advanced-heading guten-ogZUOt">
                    <div className="heading-section">
                      <h2 className="heading-title"><span className="heading-title">Subscribe to Our </span><span className="heading-focus">Newsletter</span></h2>
                    </div>
                  </div>

                  <div className="guten-element gutenverse-text-editor guten-Cs5adC">
                    <div className="text-content-inner">
                      <p>Subscribe to the Ariva Infotech newsletter to receive monthly breakdowns, articles, and product releases from our engineering team.</p>
                    </div>
                  </div>

                  <div className="guten-element guten-wrap-helper no-margin guten-zHUGbD flex">
                    <div className="guten-inner-wrap" data-id="zHUGbD">
                      <form className="guten-element guten-form-builder guten-SzFdrh" onSubmit={(e) => { e.preventDefault(); alert('Thank you for subscribing to our newsletter!'); }}>
                        <div className="guten-element guten-wrap-helper no-margin guten-G7Ek1D flex">
                          <div className="guten-inner-wrap" data-id="G7Ek1D" style={{ display: 'flex', gap: '10px', alignItems: 'center', width: '100%' }}>
                            <div className="guten-element guten-form-input-email guten-form-input guten-input-position-top guten-U5ZUz6 hide-label hide-helper" style={{ flexGrow: 1 }}>
                              <div className="main-wrapper">
                                <input placeholder="Enter your email" name="input-email" className="gutenverse-input gutenverse-input-email" type="email" required style={{ width: '100%', padding: '12px 20px', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.15)', background: 'rgba(0,0,0,0.3)', color: '#ffffff' }} />
                              </div>
                            </div>
                            <div className="guten-element guten-button-wrapper guten-submit-wrapper guten-YyzR8G">
                              <button className="guten-button gutenverse-input-submit guten-button-sm" type="submit" style={{ padding: '12px 30px' }}>
                                <span>Subscribe</span>
                              </button>
                            </div>
                          </div>
