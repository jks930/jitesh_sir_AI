  ...
  return (
    <header className="wp-block-template-part">
                ...
                <div className="guten-popup guten-popup-center guten-popup-side-space">
                    ...
                    <div className="guten-popup-wrapper guten-popup-wrapper-center">
                        <div className="guten-popup-content">
                            <div className="guten-popup-close"><i className="fas fa-times"></i></div>
            ...
            <div className="guten-element guten-popup-builder guten-LDtg6c" data-trigger="click" data-anchor="off-canvas" data-close-overlay="true">
                <div className="guten-popup guten-popup-right guten-popup-side-space">
                    <div className="guten-popup-overlay"></div>
                    <div className="guten-popup-wrapper guten-popup-wrapper-center">
                                                                    ...
                                                                    <div className="guten-container guten-column-gap-no">
                                                                        ...
                                                                        <div className="wp-block-gutenverse-column guten-element guten-column guten-Pr6FJg">
                                                                            <div className="guten-column-wrapper" data-id="Pr6FJg">
                                                                                <form style={{display: "none"}} className="guten-element guten-form-builder guten-hIp70M" data-form-id="785">
                            ...
                            <div className="guten-column-wrapper" data-id="NKDRpm">
                                <div id="guten-hV9rrC" className="guten-element guten-nav-menu nav-menu break-point-tablet submenu-click-title " data-item-indicator="gtn gtn-angle-down-solid" data-item-indicator-type="icon" data-item-indicator-svg="" data-close-on-click="1" aria-label="">
                                    <div className="gutenverse-hamburger-wrapper">
                                        <button className="gutenverse-hamburger-menu" aria-label="">
				<i aria-hidden="true" className="gtn gtn-bars-solid"></i>
				</button>
                                    </div>
                                    <div className="guten-nav-overlay"></div>
                                    <div className="gutenverse-menu-wrapper">
                                        <div className="gutenverse-menu-container">
                                            <ul id="menu-artifice-1" className="gutenverse-menu">
                                                <li id="menu-item-51" className="menu-item-51  menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home"><Link to="/" aria-label="Home">Home</a></li>
                                                <li id="menu-item-52" className="menu-item-52  menu-item menu-item-type-custom menu-item-object-custom"><Link to="/about-us/" aria-label="About Us">About Us</a></li>
                                                <li id="menu-item-53" className="menu-item-53  menu-item menu-item-type-custom menu-item-object-custom"><Link to="/services/" aria-label="Services">Services</a></li>
                                                <li id="menu-item-54" className="menu-item-54  menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children"><a href="#" aria-label="Pages">Pages</a>
                                                    <ul className="sub-menu">
                                                        <li id="menu-item-55" className="menu-item-55  menu-item menu-item-type-custom menu-item-object-custom"><Link to="/projects/" aria-label="Projects">Projects</a></li>
                                                        <li id="menu-item-56" className="menu-item-56  menu-item menu-item-type-custom menu-item-object-custom"><Link to="/faq/" aria-label="FAQ">FAQ</a></li>
                                                    </ul>
                                                </li>
                                                <li id="menu-item-57" className="menu-item-57  menu-item menu-item-type-custom menu-item-object-custom"><Link to="/blog/" aria-label="Blog">Blog</a></li>
                        ...
                        <div className="wp-block-gutenverse-column guten-element guten-column guten-Y3M6UW hide-tablet hide-mobile">
                            <div className="guten-column-wrapper" data-id="Y3M6UW">
                                <div className="wp-block-gutenverse-icon guten-element guten-HcCS8m guten-icon hide-tablet hide-mobile"><a className="guten-icon-wrapper rounded stacked" href="#search"><i className="gtn gtn-search11-light"></i></a></div>



                                <div className="wp-block-gutenverse-icon guten-element guten-M7eyUP guten-icon hide-mobile"><a className="guten-icon-wrapper circle stacked" href="#off-canvas"><i className="gtn gtn-bars-solid"></i></a></div>
                            </div>
                        </div>
                    </div>
                </section>
