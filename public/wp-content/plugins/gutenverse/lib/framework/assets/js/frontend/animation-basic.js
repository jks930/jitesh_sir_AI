(() => {
    var t = {
            ...
            850(t, e, n) {
                var r = n(11),
                    ...
                    g = s(c),
                    j = u;
                (r && j(new r(new ArrayBuffer(1))) != d || o && j(new o) != p || i && j(i.resolve()) != l || a && j(new a) != f || c && j(new c) != h) && (j = function(t) {
                    var e = u(t),
            ...
            686(t, e, n) {
                ...
                t.exports = function(t) {
                    if (null == t) return !0;
                    if (c(t) && (a(t) || "string" == typeof t || "function" == typeof t.splice || u(t) || p(t) || i(t))) return !t.length;
                    var e = o(t);
    ...
    n.n = t => {
        ...
        var p = ["fadeIn", "fadeInLeft", "fadeInDown", "fadeInRight", "fadeInUp", "slideInLeft", "slideInDown", "slideInRight", "slideInUp", "zoomIn", "zoomInLeft", "zoomInDown", "zoomInRight", "zoomInUp", "bounceIn", "bounceInLeft", "bounceInDown", "bounceInRight", "bounceInUp", "rotateIn", "rotateInDownLeft", "rotateInDownRight", "rotateInUpLeft", "rotateInUpRight", "bounce", "flash", "pulse", "rubberBand", "shake", "headShake", "swing", "tada", "wobble", "jello", "lightSpeedIn", "rollIn"],
        ...
        var v = function() {
                return i(function e(n) {
                    t(this, e), n && (this._elements = n, this.init())
                }, [{
                    ...
                    value: function(t) {
                        ...
                        if (l.map(function(t) {
                            ...
                            t.hasClass("guten-element-hide") && h()(e) && t.removeClass("guten-element-hide")
                        }
                        return {
                            animationClass: e,
                            animationClasses: r
        ...
        var w = function(n) {
                function r() {
                    return t(this, r), n = this, i = arguments, o = a(o = r),
                        function(t, n) {
                        ...
                        }(n, j() ? Reflect.construct(o, i || [], a(n).constructor) : o.apply(n, i));
                    var n, o, i
                }
                return function(t, e) {
                    ...
                    value: function(t) {
                        var e = g()(t),
                            n = this.getAnimationClass(e),
                            r = n.animationClass,
                            o = n.animationClasses;
                        if (r) {
                            var i = function() {
                                var n = t.getBoundingClientRect().top <= .75 * window.innerHeight,
                                    i = t.getBoundingClientRect().top > 0 && window.innerHeight + Math.ceil(window.pageYOffset) >= document.body.offsetHeight - .25 * window.innerHeight;
                                (n || i) && (o.map(function(t) {
                                    return e.removeClass(t)
                                }), e.addClass("__".concat(r)), e.first().addEventListener("animationstart", function(t) {
                                    t.stopPropagation(), e.removeClass("guten-element-hide")
                                }), e.first().addEventListener("animationend", function(t) {
                                    t.stopPropagation(), e.removeClass("animated")
                                }))
                            };
                            window.addEventListener("load", i), window.addEventListener("scroll", i)
                        } else {
                            if (e.hasClass("guten-button-wrapper")) {
                                var a = g()(t).find(".guten-button");
                                a && this.playAnimationOnView(a.first())
                            }
                            if (e.hasClass("guten-advance-button-wrapper")) {
                                var c = g()(t).find(".guten-advance-button");
                                c && this.playAnimationOnView(c.first())
                            }
                        }
                    }
                }])
