(() => {
    ...
    var s = {
        ...
        key: function(n) {
            return !t.hasOwnProperty(n) && !r.hasOwnProperty(n) && "targets" !== n && "keyframes" !== n
        }
    };
    ...
    function l(n, e) {
        var t = f(n),
            r = u(s.und(t[0]) ? 1 : t[0], .1, 100),
            a = u(s.und(t[1]) ? 100 : t[1], .1, 100),
            i = u(s.und(t[2]) ? 10 : t[2], .1, 100),
            c = u(s.und(t[3]) ? 0 : t[3], .1, 100),
            l = Math.sqrt(a / r),
            d = i / (2 * Math.sqrt(a * r)),
        ...
        function h(n) {
            var t = e ? e * n / 1e3 : n;
            return t = d < 1 ? Math.exp(-t * d * l) * (1 * Math.cos(p * t) + v * Math.sin(p * t)) : (1 + v * t) * Math.exp(-t * l), 0 === n || 1 === n ? n : 1 - t
        }
        return e ? h : function() {
            var e = o.springs[n];
            if (e) return e;
    ...
    function d(n) {
        return void 0 === n && (n = 10),
            function(e) {
                return Math.ceil(u(e, 1e-6, 1) * n) * (1 / n)
            }
    }
    var p, v, h = function() {
            var n = .1;
            ...
            return function(e, t, r, u) {
                if (0 <= e && e <= 1 && 0 <= r && r <= 1) {
                    ...
                    return function(c) {
                        return e === t && r === u || 0 === c || 1 === c ? c : a(function(t) {
        ...
        g = (p = {
            ...
            var e = v[n];
            p["easeIn" + n] = e, p["easeOut" + n] = function(n, t) {
                return function(r) {
                    return 1 - e(n, t)(1 - r)
                }
            }, p["easeInOut" + n] = function(n, t) {
                return function(r) {
                    return r < .5 ? e(n, t)(2 * r) / 2 : 1 - e(n, t)(-2 * r + 2) / 2
                }
            }, p["easeOutIn" + n] = function(n, t) {
                return function(r) {
    ...
    function k(n, e) {
        var t = O(n);
        for (var r in e) t[r] = s.und(n[r]) ? e[r] : n[r];
        return t
    }
    ...
    function T(n, e, t) {
        if (x([t, "deg", "rad", "turn"], C(e))) return e;
        var r = o.CSS[e + t];
        if (!s.und(r)) return r;
    ...
    function S(n, e) {
        return s.dom(n) && !s.inp(n) && (!s.nil(D(n, e)) || s.svg(n) && n[e]) ? "attribute" : s.dom(n) && x(a, e) ? "transform" : s.dom(n) && "transform" !== e && B(n, e) ? "css" : null != n[e] ? "object" : void 0
    }
            ...
            case "transform":
                return function(n, e, t, r) {
                    var a = i(e, "scale") ? 1 : 0 + function(n) {
                        ...
                        o = j(n).get(e) || a;
                    return t && (t.transforms.list.set(e, o), t.transforms.last = e), r ? T(n, o, r) : o
                }(n, e, r, t);
            case "css":
                return B(n, e, t);
            case "attribute":
    ...
    function A(n, e) {
        if (s.col(n)) return function(n) {
            return s.rgb(n) ? (t = /rgb\((\d+,\s*[\d]+,\s*[\d]+)\)/g.exec(e = n)) ? "rgba(" + t[1] + ",1)" : e : s.hex(n) ? function(n) {
    ...
    function q(n) {
        ...
        switch (n.tagName.toLowerCase()) {
            case "circle":
                return function(n) {
                    return 2 * Math.PI * D(n, "r")
                }(n);
            case "rect":
                return function(n) {
                    return 2 * D(n, "width") + 2 * D(n, "height")
                }(n);
            case "line":
                return function(n) {
                    return N({
            ...
            case "polygon":
                return function(n) {
                    var e = n.points;
                    return L(n) + N(e.getItem(e.numberOfItems - 1), e.getItem(0))
                }(n)
        }
    }
    ...
    function $(n, e) {
        var t = /[+-]?\d*\.?\d+(?:\.\d+)?(?:[eE][+-]?\d+)?/g,
            r = A(s.pth(n) ? n.totalLength : n, e) + "";
        return {
            original: r,
            numbers: r.match(t) ? r.match(t).map(Number) : [0],
            strings: s.str(n) || e ? r.split(t) : []
        }
    }

    function W(n) {
        return b(n ? M(s.arr(n) ? n.map(w) : w(n)) : [], function(n, e, t) {
    ...
    function Y(n, e) {
        var t = O(e);
        if (/^spring/.test(t.easing) && (t.duration = l(t.easing)), s.arr(n)) {
            var r = n.length;
            2 !== r || s.obj(n[0]) ? s.fnc(e.duration) || (t.duration = e.duration / r) : n = {
                value: n
            }
        }
        var a = s.arr(n) ? n : [n];
        return a.map(function(n, t) {
            var r = s.obj(n) && !s.pth(n) ? n : {
                value: n
            };
            return s.und(r.delay) && (r.delay = t ? 0 : e.delay), s.und(r.endDelay) && (r.endDelay = t === a.length - 1 ? e.endDelay : 0), r
        }).map(function(n) {
            return k(n, t)
        })
    }
                        ...
                        var r = function(n, e) {
                                ...
                                return n.tweens.map(function(r) {
                                    var a = function(n, e) {
                                        ...
                                        u = s.arr(o) ? o[1] : o,
                                        i = C(u),
                                        c = E(e.target, n.name, i, e),
                                        f = t ? t.to.original : c,
                                        l = s.arr(o) ? o[0] : f,
                                        d = C(l) || C(c),
                                        p = i || d;
                                    return s.und(u) && (u = f), a.from = $(l, p), a.to = $(F(u, l), p), a.start = t ? t.end : 0, a.end = a.start + a.delay + a.duration + a.endDelay, a.easing = m(a.easing, a.duration), a.isPath = s.pth(o), a.isPathTargetInsideSVG = a.isPath && s.svg(e.target), a.isColor = s.col(a.from.original), a.isColor && (a.round = 1), t = a, a
                                })
                            }(e, n),
                            a = r[r.length - 1];
                        return {
    ...
    var z = 0,
        ...
        J = function() {
            ...
            function e(t) {
                for (var r = R.length, a = 0; a < r;) {
                    var o = R[a];
                    o.paused ? (R.splice(a, 1), r--) : (o.tick(t), a++)
                }
                n = a > 0 ? requestAnimationFrame(e) : void 0
            }
            return "undefined" != typeof document && document.addEventListener("visibilitychange", function() {
                    U.suspendWhenDocumentHidden && (K() ? n = cancelAnimationFrame(n) : (R.forEach(function(n) {
                        return n._onDocumentVisibility()
                    }), J()))
                }),
                function() {
                    n || K() && U.suspendWhenDocumentHidden || !(R.length > 0) || (n = requestAnimationFrame(e))
                }
        }();
    ...
    function U(n) {
                    ...
                    for (var a in r && (e = k(function(n) {
                            for (var e = b(M(n.map(function(n) {
                                    ...
                                    t[a] = n.map(function(n) {
                                        var e = {};
                                        for (var t in n) s.key(t) ? t == a && (e.value = n[t]) : e[t] = n[t];
                                        return e
                                    })
                                }, a = 0; a < e.length; a++) r(a);
                            return t
                        }(r), e)), e) s.key(a) && t.push({
                        name: a,
                        tweens: Y(e[a], n)
                    });
                    return t
        ...
        function h() {
            a = 0, o = v(d.currentTime) * (1 / U.speed)
        }
        ...
        function m(n) {
            for (var e = 0, t = d.animations, r = t.length; e < r;) {
                ...
                for (var f = u(n - s.start - s.delay, 0, s.duration) / s.duration, l = isNaN(f) ? 1 : s.easing(f), p = s.to.strings, v = s.round, h = [], g = s.to.numbers.length, m = void 0, y = 0; y < g; y++) {
                    var M = void 0,
                        w = s.to.numbers[y],
                        x = s.from.numbers[y] || 0;
                    M = s.isPath ? V(s.value, l * w, s.isPathTargetInsideSVG) : x + l * (w - x), v && (s.isColor && y > 2 || (M = Math.round(M * v) / v)), h.push(M)
                }
                var O = p.length;
                if (O) {
                    m = p[0];
                ...
                Z[a.type](o.target, a.property, m, o.transforms), a.currentValue = m, e++
            }
        }
        ...
        return l(d), d.reset = function() {
            ...
            for (var t = c = e.length; t--;) d.children[t].reset();
            (d.reversed && !0 !== d.loop || "alternate" === n && 1 === d.loop) && d.remaining++, m(d.reversed ? d.duration : 0)
        }, d._onDocumentVisibility = h, d.set = function(n, e) {
            return _(n, e), d
        }, d.tick = function(n) {
            i = n, a || (a = i), w((i + (o - a)) * U.speed)
        }, d.seek = function(n) {
            w(v(n))
        }, d.pause = function() {
            d.paused = !0, h()
        }, d.play = function() {
            d.paused && (d.completed && d.reset(), d.paused = !1, R.push(d), h(), J())
        }, d.reverse = function() {
    ...
    function nn(n, e) {
        for (var t = e.length; t--;) x(n, e[t].animatable.target) && e.splice(t, 1)
    }
    ...
    function en(n, e) {
        ...
        for (var a = r.length; a--;) {
            var o = r[a],
                u = o.animations;
            nn(n, u), u.length || o.children.length || r.splice(a, 1)
        }
        t.length || r.length || e.pause()
    }
    U.version = "3.2.1", U.speed = 1, U.suspendWhenDocumentHidden = !0, U.running = R, U.remove = function(n) {
        for (var e = W(n), t = R.length; t--;) en(e, R[t])
    }, U.get = E, U.set = _, U.convertPx = T, U.path = function(n, e) {
        var t = s.str(n) ? y(n)[0] : n,
            r = e || 100;
        return function(n) {
            return {
                property: n,
        ...
        return function(n, e, s) {
            if (i && (u = 0), c && (u = (s - 1) / 2), f && (u = s - 1), !g.length) {
                for (var m = 0; m < s; m++) {
                    if (a) {
                        var b = c ? (a[0] - 1) / 2 : u % a[0],
                            ...
                            O = Math.sqrt(w * w + x * x);
                        "x" === o && (O = -w), "y" === o && (O = -x), g.push(O)
                    } else g.push(Math.abs(u - m));
                    y = Math.max.apply(Math, g)
                }
                r && (g = g.map(function(n) {
                    return r(n / y) * y
                })), "reverse" === t && (g = g.map(function(n) {
        ...
        return e.duration = 0, e.add = function(t, a) {
            ...
            var l = e.duration;
            f.autoplay = !1, f.direction = e.direction, f.timelineOffset = s.und(a) ? l : F(a, l), i(e), e.seek(f.timelineOffset);
            var d = U(f);
            i(d), u.push(d);
            var p = Q(u, n);
            return e.delay = p.delay, e.endDelay = p.endDelay, e.duration = p.duration, e.seek(0), e.reset(), e.autoplay && e.play(), e
        }, e
    }, U.easing = m, U.penner = g, U.random = function(n, e) {
