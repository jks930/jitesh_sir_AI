        ...
        7659(e, t, s) {
            ...
            function d(e) {
                return void 0 === e && (e = {}), a || (a = function(e) {
                    ...
                    const f = a.match(/(iPod)(.*OS\s([\d_]+))?/),
                        ...
                        m = "Win32" === n;
                    let v = "MacIntel" === n;
                    return !u && v && s.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${d}x${c}`) >= 0 && (u = a.match(/(Version)\/([\d.]+)/), u || (u = [0, 1, "13_0_0"]), v = !1), p && !m && (o.os = "android", o.android = !0), (u || h || f) && (o.os = "ios", o.ios = !0), o
                }(e)), a
            }
            var c = {
                on(e, t, s) {
                ...
                m = e => {
                    ...
                    if (e.params.rewind || e.params.loop)
                        for (let i = r - t; i <= n + t; i += 1) {
                            ...
                            for (let i = Math.max(r - t, 0); i <= Math.min(n + t, s - 1); i += 1) i !== r && (i > n || i < r) && h(e, i)
                };
            var v = {
                updateSize: function() {
                    const e = this;
                    let t, s;
                    const i = e.el;
                    t = void 0 !== e.params.width && null !== e.params.width ? e.params.width : i.clientWidth, s = void 0 !== e.params.height && null !== e.params.height ? e.params.height : i.clientHeight, 0 === t && e.isHorizontal() || 0 === s && e.isVertical() || (t = t - parseInt((0, r.p)(i, "padding-left") || 0, 10) - parseInt((0, r.p)(i, "padding-right") || 0, 10), s = s - parseInt((0, r.p)(i, "padding-top") || 0, 10) - parseInt((0, r.p)(i, "padding-bottom") || 0, 10), Number.isNaN(t) && (t = 0), Number.isNaN(s) && (s = 0), Object.assign(e, {
                        width: t,
                        height: s,
                ...
                updateSlides: function() {
                    ...
                    for (let i = 0; i < u; i += 1) {
                        let n;
                        if (M = 0, p[i] && (n = p[i]), E && e.grid.updateSlide(i, n, p), !p[i] || "none" !== (0, r.p)(n, "display")) {
                            ...
                            p[i] && (p[i].swiperSlideSize = M), m.push(M), s.centeredSlides ? (b = b + M / 2 + y / 2 + T, 0 === y && 0 !== i && (b = b - a / 2 - T), 0 === i && (b = b - a / 2 - T), Math.abs(b) < .001 && (b = 0), s.roundLengths && (b = Math.floor(b)), x % s.slidesPerGroup === 0 && f.push(b), h.push(b)) : (s.roundLengths && (b = Math.floor(b)), (x - Math.min(e.params.slidesPerGroupSkip, x)) % e.params.slidesPerGroup === 0 && f.push(b), h.push(b), b = b + M + T), e.virtualSize += M + T, y = M, x += 1
                        }
                    }
                    if (e.virtualSize = Math.max(e.virtualSize, a) + g, o && l && ("slide" === s.effect || "coverflow" === s.effect) && (i.style.width = `${e.virtualSize+T}px`), s.setWrapperSize && (i.style[e.getDirectionLabel("width")] = `${e.virtualSize+T}px`), E && e.grid.updateWrapperSize(M, f), !s.centeredSlides) {
                        const t = [];
                    ...
                    if (Object.assign(e, {
                        ...
                        (0, r.s)(i, "--swiper-centered-offset-before", -f[0] + "px"), (0, r.s)(i, "--swiper-centered-offset-after", e.size / 2 - m[m.length - 1] / 2 + "px");
                ...
                updateSlidesProgress: function(e) {
                    ...
                    for (let e = 0; e < i.length; e += 1) {
                        ...
                        const c = (a + (s.centeredSlides ? t.minTranslate() : 0) - d) / (l.swiperSlideSize + o),
                            u = (a - n[0] + (s.centeredSlides ? t.minTranslate() : 0) - d) / (l.swiperSlideSize + o),
                            f = -(a - d),
                            h = f + t.slidesSizesGrid[e],
                            m = f >= 0 && f <= t.size - t.slidesSizesGrid[e],
                            v = f >= 0 && f < t.size - 1 || h > 1 && h <= t.size || f <= 0 && h >= t.size;
                        v && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e)), p(l, v, s.slideVisibleClass), p(l, m, s.slideFullyVisibleClass), l.progress = r ? -c : c, l.originalProgress = r ? -u : u
                    }
                },
                ...
                updateSlidesClasses: function() {
                    ...
                    d && (o || (p = (0, r.q)(d, `.${s.slideClass}, swiper-slide`)[0], s.loop && !p && (p = t[0]), c = (0, r.r)(d, `.${s.slideClass}, swiper-slide`)[0], s.loop && 0 === !c && (c = t[t.length - 1]))), t.forEach(e => {
                        u(e, e === d, s.slideActiveClass), u(e, e === p, s.slideNextClass), u(e, e === c, s.slidePrevClass)
                    }), e.emitSlidesClasses()
                },
            ...
            var w = {
                    slideTo: function(e, t, s, i, n) {
                        ...
                        if (!m && !i && !n || a.destroyed || a.animating && l.preventInteractionOnTransition) return !1;
                        if (void 0 === t && (t = a.params.speed), void 0 === a.params.slidesPerGroupSkip) return !1;
                        ...
                        let S;
                        if (o !== (p || 0) && s && a.emit("beforeSlideChangeStart"), a.updateProgress(w), S = o > u ? "next" : o < u ? "prev" : "reset", f && -w === a.translate || !f && w === a.translate) return a.updateActiveIndex(o), l.autoHeight && a.updateAutoHeight(), a.updateSlidesClasses(), "slide" !== l.effect && a.setTranslate(w), "reset" !== S && (a.transitionStart(s, S), a.transitionEnd(s, S)), !1;
                        if (l.cssMode) {
                ...
                S = {
                    ...
                    loopFix: function(e) {
                        ...
                        c.length < v + w ? (0, r.u)("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled and not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : S && "row" === h.grid.fill && (0, r.u)("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
                        const T = [],
                            b = [];
                        let y = d.activeIndex;
                        ...
                        let M = 0,
                            C = 0;
                        const P = S ? Math.ceil(c.length / h.grid.rows) : c.length,
                        ...
                        if (d.__preventObserver__ = !0, requestAnimationFrame(() => {
                            ...
                            }), d.recalcSlides(), "auto" === h.slidesPerView ? d.updateSlides() : S && (T.length > 0 && E || b.length > 0 && x) && d.slides.forEach((e, t) => {
                            ...
                            if (T.length > 0 && E) {
                                if (void 0 === t) {
                                    ...
                                    l ? d.setTranslate(d.translate - t) : (d.slideTo(y + Math.ceil(M), 0, !1, !0), n && (d.touchEventsData.startTranslate = d.touchEventsData.startTranslate - t, d.touchEventsData.currentTranslate = d.touchEventsData.currentTranslate - t))
                                } else if (n) {
                            ...
                            if (void 0 === t) {
                                ...
                                l ? d.setTranslate(d.translate - t) : (d.slideTo(y - C, 0, !1, !0), n && (d.touchEventsData.startTranslate = d.touchEventsData.startTranslate - t, d.touchEventsData.currentTranslate = d.touchEventsData.currentTranslate - t))
                            } else {
            ...
            function y(e) {
                ...
                if (a.touchReleaseOnEdges && !a.loop)
                    if (t.isVertical()) {
                        if (f < o.startY && t.translate <= t.maxTranslate() || f > o.startY && t.translate >= t.minTranslate()) return n.isTouched = !1, void(n.isMoved = !1)
                ...
                n.allowTouchCallbacks && t.emit("touchMove", p), o.previousX = o.currentX, o.previousY = o.currentY, o.currentX = u, o.currentY = f;
                const h = o.currentX - o.startX,
                    m = o.currentY - o.startY;
                if (t.params.threshold && Math.sqrt(h ** 2 + m ** 2) < t.params.threshold) return;
                if (void 0 === n.isScrolling) {
                    let e;
                    t.isHorizontal() && o.currentY === o.startY || t.isVertical() && o.currentX === o.startX ? n.isScrolling = !1 : h * h + m * m >= 25 && (e = 180 * Math.atan2(Math.abs(m), Math.abs(h)) / Math.PI, n.isScrolling = t.isHorizontal() ? e > a.touchAngle : 90 - e > a.touchAngle)
                }
                if (n.isScrolling && t.emit("touchMoveOpposite", p), void 0 === n.startMoving && (o.currentX === o.startX && o.currentY === o.startY || (n.startMoving = !0)), n.isScrolling || "touchmove" === p.type && n.preventTouchMoveFromPointerMove) return void(n.isTouched = !1);
                ...
                let b = !0,
                    y = a.resistanceRatio;
                if (a.touchReleaseOnEdges && (y = 0), v > 0 ? (S && T && n.allowThresholdMove && n.currentTranslate > (a.centeredSlides ? t.minTranslate() - t.slidesSizesGrid[t.activeIndex + 1] : t.minTranslate()) && t.loopFix({
                        direction: "prev",
                        setTranslate: !0,
                        activeSlideIndex: 0
                    }), n.currentTranslate > t.minTranslate() && (b = !1, a.resistance && (n.currentTranslate = t.minTranslate() - 1 + (-t.minTranslate() + n.startTranslate + v) ** y))) : v < 0 && (S && T && n.allowThresholdMove && n.currentTranslate < (a.centeredSlides ? t.maxTranslate() + t.slidesSizesGrid[t.slidesSizesGrid.length - 1] : t.maxTranslate()) && t.loopFix({
                        direction: "next",
                        setTranslate: !0,
            ...
            const L = (e, t) => {
                    ...
                    i && "string" != typeof i && (a[l]("touchstart", e.onDocumentTouchStart, {
                        passive: !1,
                        capture: o
                        ...
                        passive: !0
                    }), (s.preventClicks || s.preventClicksPropagation) && i[l]("click", e.onClick, !0), s.cssMode && r[l]("scroll", e.onScroll), s.updateOnWindowResize ? e[d](n.ios || n.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", E, !0) : e[d]("observerUpdate", E, !0), i[l]("load", e.onLoad, {
                        capture: !0
                    }))
                },
            ...
            const z = {
                    ...
                    events: {
                        attachEvents: function() {
                            ...
                            e.onTouchStart = b.bind(e), e.onTouchMove = y.bind(e), e.onTouchEnd = x.bind(e), e.onDocumentTouchStart = I.bind(e), t.cssMode && (e.onScroll = C.bind(e)), e.onClick = M.bind(e), e.onLoad = P.bind(e), L(e, "on")
                        },
                    ...
                    breakpoints: {
                        setBreakpoint: function() {
                            ...
                            const h = l.direction && l.direction !== i.direction,
                                ...
                                v = i.loop;
                            h && s && e.changeDirection(), (0, r.w)(e.params, l);
                            ...
                            }), f && !g ? e.disable() : !f && g && e.enable(), e.currentBreakpoint = o, e.emit("_beforeBreakpoint", l), s && (m ? (e.loopDestroy(), e.loopCreate(t), e.updateSlides()) : !v && w ? (e.loopCreate(t), e.updateSlides()) : v && !w && e.loopDestroy()), e.emit("breakpoint", l)
                        },
            ...
            class D {
                constructor() {
                    let e, t;
                    for (var s = arguments.length, n = new Array(s), a = 0; a < s; a++) n[a] = arguments[a];
                    1 === n.length && n[0].constructor && "Object" === Object.prototype.toString.call(n[0]).slice(8, -1) ? t = n[0] : [e, t] = n, t || (t = {}), t = (0, r.w)({}, t), e && !t.el && (t.el = e);
                    const c = (0, i.g)();
                    ...
                    const p = this;
                    p.__swiper__ = !0, p.support = l(), p.device = d({
                    ...
                    const f = (0, r.w)({}, O, u);
                    return p.params = (0, r.w)({}, f, G, t), p.originalParams = (0, r.w)({}, p.params), p.passedParams = (0, r.w)({}, t), p.params && p.params.on && Object.keys(p.params.on).forEach(e => {
                ...
                destroy(e, t) {
                    ...
                    return void 0 === s.params || s.destroyed || (s.emit("beforeDestroy"), s.initialized = !1, s.detachEvents(), i.loop && s.loopDestroy(), t && (s.removeClasses(), n && "string" != typeof n && n.removeAttribute("style"), a && a.removeAttribute("style"), o && o.length && o.forEach(e => {
